...
template<> class numeric_limits<::imgio::f16> {
public:
	static const bool is_specialized = true;
	static imgio::f16 min () { return imgio::f16(0, 1, 0); }
	static imgio::f16 max () { return imgio::f16(0, 30, 0xFFFFu); }
	...
	static imgio::f16 epsilon () { return 0.0009765625f; } // 2^-10
	static imgio::f16 round_error () { return 0.00048828125; } // 2^-11
	...
	static imgio::f16 denorm_min() { return imgio::f16(1, 0, 1); }
	static imgio::f16 infinity() { return imgio::f16(0, 31, 0); }
	static imgio::f16 quiet_NaN() { return imgio::f16(0, 31, 1); }
	static imgio::f16 signaling_NaN() { return imgio::f16(0, 31, 1); }
};

template<> struct is_floating_point<::imgio::f16> : std::true_type {};
